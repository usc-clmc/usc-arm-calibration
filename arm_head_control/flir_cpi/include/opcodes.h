 ...
 *****                 C include file                        *****
 *****                                                       *****
 *****     (C) 1994 - 2010, FLIR Motion Control Systems, Inc.*****
 *****               All rights reserved.                    *****
 *****************************************************************/

#define OPCODE_VERSION		"v1.09.15"


/********* REVISION HISTORY *********/
/*
          7/25/06: Fixed Async Event Check for negative numbers
2.12.12  16Feb06 : Added ISM support
1.07.07: 11/10/99: Added ASYNCHRONOUS_EVENT test for asynchronous return codes.
