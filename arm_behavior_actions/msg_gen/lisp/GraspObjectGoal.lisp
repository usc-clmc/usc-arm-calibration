...
(cl:defmethod cl:initialize-instance :after ((m <GraspObjectGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspObjectGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_behavior_actions-msg:<GraspObjectGoal> is deprecated: use arm_behavior_actions-msg:GraspObjectGoal instead.")))
...
(cl:defmethod target-val ((m <GraspObjectGoal>))
...
(cl:defmethod retry_status-val ((m <GraspObjectGoal>))
  ...
  (retry_status m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<GraspObjectGoal>)))
    "Constants for message type '<GraspObjectGoal>"
  '((:FIRST_TIME . 0))
)
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql 'GraspObjectGoal)))
    "Constants for message type 'GraspObjectGoal"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GraspObjectGoal>)))
  ...
  "arm_behavior_actions/GraspObjectGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GraspObjectGoal)))
  "Returns string type for a message object of type 'GraspObjectGoal"
  "arm_behavior_actions/GraspObjectGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GraspObjectGoal>)))
  ...
  "990eae5804a2e87bbaf03bbecc26aa14")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GraspObjectGoal)))
  "Returns md5sum for a message object of type 'GraspObjectGoal"
  "990eae5804a2e87bbaf03bbecc26aa14")
