...
(cl:defclass <ARMarkers> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector ar_target-msg:ARMarker)
   :initform (cl:make-array 0 :element-type 'ar_target-msg:ARMarker :initial-element (cl:make-instance 'ar_target-msg:ARMarker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ARMarkers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ARMarkers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ar_target-msg:<ARMarkers> is deprecated: use ar_target-msg:ARMarkers instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ARMarkers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ar_target-msg:ARMarker))
